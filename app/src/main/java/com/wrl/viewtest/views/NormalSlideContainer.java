 ...
 */
public class NormalSlideContainer extends HorizontalScrollView {
	public enum Status {
		OPEN, CLOSE
	}

	public NormalSlideContainer(Context context) {
		this(context, null, 0);
	}

	public NormalSlideContainer(Context context, AttributeSet attrs) {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        ViewHelper.setTranslationX(mMenu,l*2/3);
    }
}
